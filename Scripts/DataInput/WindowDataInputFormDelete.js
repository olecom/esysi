...
Ext.define("ManAcc.DataInput.WindowDataInputFormDelete", {
        ...
        var grid = Ext.create('Ext.grid.Panel', {
            ...
            listeners: {
                itemdblclick: function (grid, record, item, index, e, eOpts) {
                    ...
                    HostApi.DataInputFormDelete(record.data.Id);
                    that.deleteToolberManuButton(record.data.Id);
                    grid.getStore().removeAt(grid.getStore().find('Id', record.data.Id));
                    //dictStore.loadRawData({ 'items': items });
                }
            }
        });
