...
Ext.define("ManAcc.Dictionaries.PanelDictionaryElementTree", {
    ...
    getValue: function () {
        var prefixLength = this.idPrefix.toString().length;
        if (this.checkbox) {
    ...
    getTitle: function () {
        ...
        if (this.checkbox) {
            ...
            var node = tree.getNodeByKey(this.value.toString());
