...
Ext.define("ManAcc.Dictionaries.WindowPropertyType", {
    ...
    constructor: function (options) {
        ...
        var btnSaveChanges = Ext.create('Ext.Button', {
        ...
        var btnSaveAsNew = Ext.create('Ext.Button', {
        ...
        var btnDeleteType = Ext.create('Ext.Button', {
            ...
            listeners: {
                select: function (dv, record, item, index, e) {
                    ...
                    if (record.data.Code == "dict") {
                        btnDeleteType.disable(true);
                        btnSaveAsNew.disable(true);
                        btnSaveChanges.enable(true);
                        formPropertyType.getForm().findField("BaseType").disable(true);
                    } else {
                        btnDeleteType.enable(true);
                        btnSaveAsNew.enable(true);
                        btnSaveChanges.enable(true);
                        formPropertyType.getForm().findField("BaseType").enable(true);
                    }
                }
            }
        });
        ...
        var formPropertyType = Ext.create('Ext.form.Panel', {
            ...
            buttons: [ btnSaveAsNew, btnSaveChanges, btnDeleteType]
        });
